...
<html lang="en">
  <head>
    <title>Projet4 - Homepage 1</title>
    <meta charset="utf-8" />
    <meta
      name="viewport"
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="get-started text-center mb-4">
                ...
                <h3> Trouver un travail</h3>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore.
                </p>
                <a href="employer-listing.php" class="theme-btn btn-style-one">chercher offre</a>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="get-started text-center mb-4">
                ...
                <a href="post-candidat.php" class="theme-btn btn-style-one">postuler</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-md-8 text-center">
                ...
                <p>
                  <a href="eris/admin/login.php" class="theme-btn btn-style-four"
                    >page admin</a
                  >
                </p>
              </div>
