            ...
            <!-- <ul class="post-job-bx">
              <li>
                <a href="candidate-single.php">
                  ...
                  <?php if(empty($¸POST['titreProffessions']) || empty($¸POST['domaine'])|| empty($¸POST['ordre'])): ?>
                <?php afficher_candidats_tous_les_candidats();?>
                <?php endif;?>
...
<form action="candidate-listing_score.php" method="post" class="search-form mb-3">
          ...
          <div class="row">
            ...
            <div class="upper-column col-lg-3 col-md-12 col-sm-12">
              <div class="footer-logo">
                <figure class="image"><a href="index.php"><img src="images/" class="img-responsive"
