...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>BRIGHTJOB</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>BRIGHTJOB</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/category/">
            <i class="fa fa-list"></i> <span>Catégorie</span>  
          </a>
        </li> 
       <!--  <li class="treeview">
          <a href="#">
         ...
         <li class="<?php echo (currentpage() == 'user') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>admin/user/">
            <i class="fa fa-user"></i> <span>Gestion d'utilisateurs</span> </a>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">BRIGHTJOB</a>.</strong> All rights
    reserved.
  </footer>
