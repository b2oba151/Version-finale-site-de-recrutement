...
?>
 <form class="form-horizontal span6" action="controller.php?action=add" method="POST">
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <h1 class="page-header">Ajouter nouveau poste vacant</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                 </div> 
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "OCCUPATIONTITLE">Titre d'occupation:</label> 
                      <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "REQ_NO_EMPLOYEES">No. requis d'employés:</label> 
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "QUALIFICATION_WORKEXPERIENCE">Qualification/Expériences Professionnels :</label> 
                      <div class="col-md-8">
                 ...
                 <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "PREFEREDSEX">Sexe Préférée:</label> 
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "SECTOR_VACANCY">Secteur de poste vacant:</label> 
                      <div class="col-md-8">
