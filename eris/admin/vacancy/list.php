...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Listes des postes vacants  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Ajouter poste vacant</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				...
				<table id="dash-table" class="table table-striped table-bordered table-hover"  style="font-size:12px" cellspacing="0">
				  ...
				  <thead>
				  	<tr>
				  		...
				  		<th>Titre d'occupation</th> 
				  		<th>No. requis d'employés</th> 
				  		<th>Salaires</th> 
				  		<th>Durée d'emploi</th> 
				  		<th>Qualification/Expériences Professionnels</th> 
				  		<th>Description de l'emploi</th> 
				  		<th>Sexe Préférée</th> 
				  		<th>Secteur de poste vacant</th> 
				  		<th>État d'emploi</th> 
