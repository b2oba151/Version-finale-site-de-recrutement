...
// $res = $autonum->single_autonumber(2);
   ...
   switch ($emp->CIVILSTATUS) {
     ...
     case 'Seule':
       # code...
        $civilstatus =' <select class="form-control input-sm" name="CIVILSTATUS" id="CIVILSTATUS">
                                      ...
                                      <option SELECTED value="Single">Seule</option>
     ...
     case 'Marié':
       # code...
         $civilstatus=' <select class="form-control input-sm" name="CIVILSTATUS" id="CIVILSTATUS">
                                      ...
                                      <option SELECTED value="Married">Marié</option>
                                      <option value="Widow" >Veuve</option>
                                      <!-- <option value="Fourth" >Fourth</option> -->
                                  </select> ';
     ...
     case 'Veuve':
       ...
       $civilstatus=' <select class="form-control input-sm" name="CIVILSTATUS" id="CIVILSTATUS">
                                      ...
                                      <option  value="Single">Seule</option>
                                      <option  value="Married">Marié</option>
                                      <option SELECTED value="Veuve" >Widow</option>
                                      <!-- <option value="Fourth" >Fourth</option> -->
                                  </select> ';
       break;
     default:
 ...
 ?> 
       ...
       <div class="center wow fadeInDown">
             <h2 class="page-header">Mise á jour</h2>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="col-md-8">
                                <label class="col-md-4 control-label" for=
                                "DATEHIRED">Date d'embauche:</label>
